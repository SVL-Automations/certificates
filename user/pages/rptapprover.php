...
if (isset($_POST['tabledata'])) {
    ...
    $result = mysqli_query($connection, "SELECT * FROM login WHERE type = 'approver'");
...
if (isset($_POST['Add'])) {
    ...
    $data = mysqli_query($connection, "INSERT INTO `login`
                                        (`name`, `password`, `username`, `status`,`type`)
                                        values
                                        ('$name', '$password','$email','1','approver')");
    ...
    if (mysqli_affected_rows($connection)==1) {
        ...
        Your new account is Created at " . $project . " as certificate approver. 
        <br/> Welcome you to the <b>" . $project . "</b>.We thank you for join with us.<br/><br/>
        
        URL : https://certificates.svlautomations.in/approver <br/>
        ...
        $subject = "Certificate approver user account created at " . $project;
        ...
        $msg->value = 1;
        $msg->data = "Approver User Added Successfully. " . $mailmsg;
...
<head>
    ...
    <title><?= $project ?> : Add Approver User</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title"> Approver Registration</h3>
                                <a class="btn btn-social-icon btn-success pull-right" style="margin:5px" title="Add New User" data-toggle="modal" data-target="#modaladdadmin"><i class="fa fa-plus"></i></a>
                            </div>
